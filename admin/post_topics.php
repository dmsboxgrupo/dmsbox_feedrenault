...
$webadm->add_button( array( 'name' => 'Novo tópico', 'icon' => 'mdi mdi-format-list-bulleted', 'url' => "post_topic_edit.php?post_id={$content_id}" ) );
$webadm->add_parent( array( 'name' => 'Comunicados', 'url' => 'communicateds.php' ) );
$webadm->add_parent( array( 'name' => 'Comunicado', 'url' => "communicated_edit.php?id=$content_id"));
