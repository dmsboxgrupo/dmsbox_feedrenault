...
if ($content_id > 0) {
	...
	if (has('post')) {	
		...
		//if($save){	 
			redirect('renault_academy.php', array(
				'message' => 'Renault Academy alterado com sucesso.',
				'type' => 'success'
			));
		/*}else{
			redirect("post_topics.php?id={$content_id}", array(
				'message' => 'Renault Academy adicionado com sucesso.',
				'type' => 'success'
			));
		}*/
...
$webadm->set_page( array( 'name' => $is_new ? 'Novo Renault Academy' : 'Editar Renault Academy' ) );

$webadm->add_parent( array( 'name' => 'Renault Academy', 'url' => 'renault_academy.php' ) );
			...
			<div class="row">
				<div class="col-md-11">
					<div class="row">
						...
						<div class="col-md-10">
							<input readonly type="text" class="form-control" placeholder="Renault Academy" />
						</div>
...
<script src="js/renault_academy_edit.js"></script>
<!-- ============================================================== -->
<!-- End Page Content -->
<!-- ============================================================== -->
<?php 
