...
if ($content_id > 0) {
	...
	if (has('post')) {	
		...
		if($save){	 
			redirect('renault_care_services.php', array(
				'message' => 'Renault Care Service alterado com sucesso.',
				'type' => 'success'
			));
		}else{
			redirect("post_topics.php?id={$content_id}", array(
				'message' => 'Renault Care Service adicionado com sucesso.',
				'type' => 'success'
			));
		}
...
$webadm->set_page( array( 'name' => $is_new ? 'Novo Renault Care Service' : 'Editar Renault Care Service' ) );

$webadm->add_parent( array( 'name' => 'Renault Care Services', 'url' => 'renault_care_services.php' ) );
			...
			<div class="row">
				<div class="col-md-11">
					<div class="row">
						...
						<div class="col-md-10">
							<input readonly type="text" class="form-control" placeholder="Renault Care Service" />
						</div>
...
<script src="js/renault_care_service_edit.js"></script>
<!-- ============================================================== -->
<!-- End Page Content -->
<!-- ============================================================== -->
<?php 
