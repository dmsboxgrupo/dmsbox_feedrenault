						...
						<div class="form-group m-b-10">
							...
							<div class="tab-content tabcontent-border">
								<div class="tab-pane p-20 active" id="home" role="tabpanel">
									...
									<div class="row">
										...
										<div class="col-md-6  d-flex align-items-center">
											<label>Cor do Texto</label> 
											<input  name="field1_color"  type="color" value="?php echo html($content['field1_color']); ?>">
										</div>-->
									</div>
								...
								<div class="tab-pane  p-20" id="profile" role="tabpanel">
									...
									<div class="form-group m-b-10">
										<label>Cor do Texto</label>
										<input  name="field2_color"  type="color" value="php echo html($content['field2_color']); ?>">
									</div>
									-->
								</div>
								...
								<div class="tab-pane p-20" id="messages" role="tabpanel">
									...
									<div class="form-group m-b-10">
										<label>Cor do Texto</label>
										<input  name="field3_color"  type="color" value="?php echo html($content['field3_color']); ?>">
									</div>
								-->
								</div>
