...
class MATERIAIS {
    constructor(){
        ...
        app.request(params, false, null, ( res ) => {
            ...
            if(res.error != null) {
                ...
                /* # VISÃO RÁPIDA # */
                // htmlCode += '<div class="item">';   
                // htmlCode += '    <a href="#" class="bt-changeview" data-target="materiais-visao-rapida" data-group="materiais">';    
                // htmlCode += '        <div class="bull">';   
                // htmlCode += '            <div class="hld">';    
                // htmlCode += '                <div class="ico" style="mask-image: url(\'assets/images/ico_visao_rapida.svg\');"></div>';   
                // htmlCode += '            </div>';   
                // htmlCode += '        </div>';   
                // htmlCode += '        <div class="txt">ficha de modelos</div>'; 
                // htmlCode += '    </a>'; 
                // htmlCode += '</div>'; 

                // arrTags.push({ materiaisURL: "materiais-visao-rapida", id: 1, hasSub: false });
                // window.hash.push({internal: 'materiais-visao-rapida', holder: 'materiais', hash: 'materiais-visao-rapida'});
                /* # VISÃO RÁPIDA # */
    ...
    init(frame, filtrado = false){
        ...
        if(materiaisbaseLoaded) {
            ...
            if(frame == 'materiais-imagens-dos-veiculos' || frame == 'materiais-visao-rapida') {
            ...
            if(materiaisID){
                ...
                if(oldFrame != frame || oldSUB != materiaisSUB || oldVersao != materiaisVersao || oldVeiculo != materiaisVeiculo || filtrado){
                    ...
                    if(frame == 'biblioteca-de-materiais'){
                        ...
                        if(frame == 'materiais-rdemos' || frame == 'materiais-visao-rapida') {
                        ...
                        if(frame == 'materiais-materiais-editaveis' && materiaisSUB == 'whatsapp' || frame == 'materiais-materiais-editaveis' && materiaisSUB == null) {
                        ...
                        } else if(frame == 'materiais-visao-rapida' && materiaisVeiculo == null){
                            $('main').attr('class', 'view-visao-rapida');
                                    ...
                                    app.request(paramsViews, false, null, ( res ) => {
                                        if(res.error != null) {
                                            ...
                                            loop.forEach(function(item) {
                                                ...
                                                htmlCode += '           <div class="midia">';
                                                htmlCode += '               <a href="#" class="bt-changeview" data-target="materiais-visao-rapida" data-medium="' + util.slugfy(item.vehicle_name) + '" data-timing="false">';
                                        ...
                                        app.request(paramsVersions, false, null, ( res ) => {
                                            if(res.error != null) {
                                                ...
                                                loop.forEach(function(item) {
                                                    ...
                                                    htmlCode += '       <div class="bt-voltar"><a href="#" class="bt-changeview" data-target="materiais-visao-rapida"><div class="ico"><img src="assets/images/ico_arrow_left.svg"></div>Voltar</a></div>';
                                                    htmlCode += '    </div>';
                                                    let name = item.name;
                                                    if(name){
                                                    ...
                                                    if(message != ''){
                                                        ...
                                                        htmlCode += '           <div class="titulo"><a href="#" class="bt-acc" data-target="secao-acc">mensagem</a></div>';
                                                    ...
                                                    if(strengths != ''){
                                                        htmlCode += '       <div class="area-acc">';
                                                        htmlCode += '           <div class="titulo"><a href="#" class="bt-acc" data-target="secao-acc">pontos fortes</a></div>';
                                                    ...
                                                    if(tags) {
                                                        for(const tag of tags) {
                                                            ...
                                                            if(numPosts > 5) {
                                                                ...
                                                                htmlCode += '    <a href="#" class="bt-mais-visao" data-target="' + openVehicle + '" data-medium="' + tag.tag_group + '" data-sub="' + tag.tag_subgroup + '">ver mais</a>';
                                                                htmlCode += '</div>';
                                                            }
                                                        }
                            ...
                            let params = { q:'feed', group:group, subgroup:subgroup };
...
function loadVisao(target, group, subgroup){
