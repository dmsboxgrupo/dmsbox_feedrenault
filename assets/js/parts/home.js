                    ...
                    loop.forEach(function(item) {
                        ...
                        if(item.pdf){
                            htmlModalCode +=    '<div class="slide">'+
                                                ...
                                                '        <div class="bts">'+
                                                '            <div class="bt">'+
                                                '                <a href="#" class="bt-baixar" data-target="' + item.share_link + '" data-vehicle="' + item.vehicles + '" data-version="' + item.version + '">baixar</a>'+
                                                '            </div>'+
                                                '            <div class="bt">'+
                                                '                <a href="#" class="bt-compartilhar" data-target="' + item.id + '" data-share-title="' + encodeURIComponent(item.title) + '" data-share-text="' + encodeURIComponent(item.message) + '" data-share-link="' + encodeURIComponent(item.share_link) + '"  data-vehicle="' + item.vehicles + '" data-version="' + item.version + '">compartilhar</a>'+
                                                '            </div>'+
                                                '        </div>'+
                                                '    </div>'+
                                                '    <div class="actions">'+
                            ...
                            htmlModalCode  +=   '<div class="slide">'+
                                                ...
                                                '        <div class="bts">'+
                                                '            <div class="bt">'+
                                                '                <a href="#" class="bt-baixar" data-target="' + link + '" data-vehicle="' + item.vehicles + '" data-version="' + item.version + '">baixar</a>'+
                                                '            </div>'+
                                                '            <div class="bt">'+
                                                '                <a href="#" class="bt-compartilhar" data-target="' + item.id + '" data-share-title="' + encodeURIComponent(item.title) + '" data-share-text="' + encodeURIComponent(item.message) + '" data-share-link="' + encodeURIComponent(item.share_link) + '"  data-vehicle="' + item.vehicles + '" data-version="' + item.version + '">compartilhar</a>'+
                                                '            </div>'+
