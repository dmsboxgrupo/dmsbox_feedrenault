...
class User {
	...
	public function create_user_panel($user) {
	...
	public function confirm ($user) {
		...
		if( $this->status == 1 && $this->status_gerente == 1) {
			...
			$this->enviaCompleto ( $this->name, $this->email);
	...
	public function enviaPendenciaGerente($usuario_novo, $id_usuario, $bir_usuario, $email_usuario){
		...
		$layout = $prefixo.'admin/emails/07_aprovar_acesso_gerente.html';
		...
		$IMG = $prefixo."admin/emails/img/logoc.jpg;".
			   $prefixo."admin/emails/img/botnegace.gif;".
			   $prefixo."admin/emails/img/botpermace.gif;".
			   $prefixo."admin/emails/img/botverperm.gif";
	...
	public function enviaCompleto($usuario_novo, $email_destino, $origem="web"){
	...
	public function enviaConfirmacao($usuario_novo, $email_destino, $origem="web"){
		...
		//print_r((array)$this);die();
		//Preparando e-mail 
		//$layout = $prefixo."admin/layoutsemails/LayoutEmail.html";
		if($this->origin==1){
			...
			/*
			$IMG = $prefixo."admin/emails/img/logop.jpg;".$prefixo."admin/emails/img/bot2_1.jpg;".$prefixo."admin/emails/img/spacer.gif;".
				$prefixo."admin/emails/img/bot2_2.jpg;".$prefixo."admin/emails/img/bot2_3.jpg;".$prefixo."admin/emails/img/bot2_4.jpg";
            */
